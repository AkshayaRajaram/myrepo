...
insert into ACC_DOCUMENT (accountId,docId) values('3','12');
...
insert into ACC_DOCUMENT (accountId,docId) values('4','11');
...
insert into Account_UW_Mapping (underWriterId ,accountId) values ('1','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('1','2');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('1','3');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('2','3');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('2','4');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('2','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('3','5');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('3','2');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('3','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('4','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('4','2');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('4','4');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('5','4');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('5','3');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('5','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('6','2');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('6','4');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('6','5');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('7','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('7','4');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('7','3');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('8','3');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('8','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('8','5');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('9','5');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('9','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('9','3');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('10','4');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('10','1');
insert into Account_UW_Mapping (underWriterId ,accountId) values ('10','5');


//INSERT QUERIES FOR UW_Mapping
insert into UW_Mapping (product_Type_id, underWriterId) values ('1','1');
insert into UW_Mapping (product_Type_id, underWriterId) values ('1','3');
insert into UW_Mapping (product_Type_id, underWriterId) values ('1','5');
insert into UW_Mapping (product_Type_id, underWriterId) values ('2','2');
insert into UW_Mapping (product_Type_id, underWriterId) values ('2','4');
insert into UW_Mapping (product_Type_id, underWriterId) values ('2','6');
insert into UW_Mapping (product_Type_id, underWriterId) values ('3','4');
insert into UW_Mapping (product_Type_id, underWriterId) values ('3','6');
insert into UW_Mapping (product_Type_id, underWriterId) values ('3','8');
insert into UW_Mapping (product_Type_id, underWriterId) values ('4','5');
insert into UW_Mapping (product_Type_id, underWriterId) values ('4','7');
insert into UW_Mapping (product_Type_id, underWriterId) values ('4','9');
insert into UW_Mapping (product_Type_id, underWriterId) values ('5','3');
insert into UW_Mapping (product_Type_id, underWriterId) values ('5','5');
insert into UW_Mapping (product_Type_id, underWriterId) values ('5','7');
insert into UW_Mapping (product_Type_id, underWriterId) values ('6','1');
insert into UW_Mapping (product_Type_id, underWriterId) values ('6','2');
insert into UW_Mapping (product_Type_id, underWriterId) values ('6','9');
insert into UW_Mapping (product_Type_id, underWriterId) values ('7','3');
insert into UW_Mapping (product_Type_id, underWriterId) values ('7','7');
insert into UW_Mapping (product_Type_id, underWriterId) values ('7','9');
insert into UW_Mapping (product_Type_id, underWriterId) values ('8','2');
insert into UW_Mapping (product_Type_id, underWriterId) values ('8','6');
insert into UW_Mapping (product_Type_id, underWriterId) values ('8','8');
...
//INSERT QUERIES FOR UW_Mapping
insert into UW_Mapping (productTypeId, underWriterId) values ('1','1');
insert into UW_Mapping (productTypeId, underWriterId) values ('1','3');
insert into UW_Mapping (productTypeId, underWriterId) values ('1','5');
insert into UW_Mapping (productTypeId, underWriterId) values ('2','2');
insert into UW_Mapping (productTypeId, underWriterId) values ('2','4');
insert into UW_Mapping (productTypeId, underWriterId) values ('2','6');
insert into UW_Mapping (productTypeId, underWriterId) values ('3','4');
insert into UW_Mapping (productTypeId, underWriterId) values ('3','6');
insert into UW_Mapping (productTypeId, underWriterId) values ('3','8');
insert into UW_Mapping (productTypeId, underWriterId) values ('4','5');
insert into UW_Mapping (productTypeId, underWriterId) values ('4','7');
insert into UW_Mapping (productTypeId, underWriterId) values ('4','9');
insert into UW_Mapping (productTypeId, underWriterId) values ('5','3');
insert into UW_Mapping (productTypeId, underWriterId) values ('5','5');
insert into UW_Mapping (productTypeId, underWriterId) values ('5','7');
insert into UW_Mapping (productTypeId, underWriterId) values ('6','1');
insert into UW_Mapping (productTypeId, underWriterId) values ('6','2');
insert into UW_Mapping (productTypeId, underWriterId) values ('6','9');
insert into UW_Mapping (productTypeId, underWriterId) values ('7','3');
insert into UW_Mapping (productTypeId, underWriterId) values ('7','7');
insert into UW_Mapping (productTypeId, underWriterId) values ('7','9');
insert into UW_Mapping (productTypeId, underWriterId) values ('8','2');
insert into UW_Mapping (productTypeId, underWriterId) values ('8','6');
insert into UW_Mapping (productTypeId, underWriterId) values ('8','8');
